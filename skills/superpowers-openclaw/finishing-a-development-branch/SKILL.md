...
**Called by:**
- **superpowers-open:executing-plans** — After all tasks complete
- **superpowers-open:writing-plans** — After plan execution complete

**Pairs with:**
- **superpowers-open:using-git-worktrees** — For worktree created by that skill
