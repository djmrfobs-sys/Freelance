...
- Invoke superpowers-open:writing-plans to create a detailed implementation plan
- The terminal state of brainstorming is writing-plans. Do NOT start coding directly.
