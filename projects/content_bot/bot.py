...
0. ДВУЯЗЫЧНОСТЬ ДЛЯ @ecstatic_dance_mantra:
   - Все посты в канал MANTRA должны быть на ДВУХ языках:
   - Сначала русский текст
   - Ниже — сербский перевод (дубляж)
   - Пример: после русского абзаца пустая строка и сербский текст
   - Для @kiselevy_creo_digital — только русский
...
def handle_message(msg):
    ...
    if text == "/start":
        send_message(chat_id,
            ...
            "🌐 *Важно:* Для @ecstatic_dance_mantra пиши текст на двух языках: сначала русский, потом сербский (через пустую строку).\n\n"
