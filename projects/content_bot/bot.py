...
5. СЕТКА РУБРИК @kiselevy_creo_digital:
   ПН — 🧠 Артур: Кейс / Разбор (конкретный случай с цифрами)
   ВТ — 🧠 Артур: Инструмент / Обзор (один инструмент)
   СР — 🎯 Кети: Маркетинг / Стратегия
   ЧТ — 🎯 Кети: Продюсирование / Воронки
   ПТ — 💪 Вместе: Полезная связка / Гайд
   СБ — 💪 Вместе: Жизнь / Процессы (как работаем вдвоём)
   ВС — 💪 Вместе: Итог недели / Мысли

   Авторство:
   - ПН, ВТ → от 1-го лица (я Артур)
   - СР, ЧТ → от 1-го лица (я Кети)
   - ПТ, СБ, ВС → от команды (мы, KISELEVY CREO)

6. ДЛЯ @ecstatic_dance_mantra:
